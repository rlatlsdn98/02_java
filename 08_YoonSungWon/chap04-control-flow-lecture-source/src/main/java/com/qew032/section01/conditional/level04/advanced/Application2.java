package com.qew032.section01.conditional.level04.advanced;
...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("월 급여 : " + montsalary);
        System.out.println("보너스 금액 : " + bonusprice);
        System.out.println("총 급여 : " + (montsalary + bonusprice));
