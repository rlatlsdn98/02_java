package com.beyond.section01.conditional.level04.advanced;
...
public class Application2 {
  public static void main(String[] args) {
    ...
    if (sellMoney >= 50000000 ) {
      bonusPercent = 5;
    }else if (sellMoney >= 30000000) {
      bonusPercent = 3;
    }else if (sellMoney >= 10000000) {
      bonusPercent = 1;
    }else {
      bonusPercent = 0;
    }

    bonusMoney = sellMoney * bonusPercent / 100;
    totalSalary = monSal + bonusMoney;
    System.out.println("======================");
    System.out.println("매출액 : " + sellMoney);
