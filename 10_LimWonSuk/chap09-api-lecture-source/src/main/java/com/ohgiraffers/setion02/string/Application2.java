package com.ohgiraffers.setion02.string;
...
public class Application2
{
    public static void main(String[] args)
    {
        ...
        *  - 동일한 값을 가진 문자열 인스턴스를 단일 인스턴스로 관리한다 (중복없이만들어 관리)
        * */

        /* String 객체를 만드는 방법
        * 1) String s1 = "abcd"; -> Constant Pool에 생성
        * 2) String s2 = new String("abcd"); -> heap 메모리 영역에 생성
        * 3) String s1 = "abcd"; // Constant Pool 에 중복되는 값이 있는지 확인후 없을시 생성 -> 중복없어서 메모리 효윯이 좋아짐
        * */
