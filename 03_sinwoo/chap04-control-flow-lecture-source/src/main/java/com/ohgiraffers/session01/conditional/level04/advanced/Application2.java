package com.ohgiraffers.session01.conditional.level04.advanced;
...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        int bonusP = 0;
        if(income >= 10000000 && income < 30000000){
            bonusP = 1;
        }else if (income >= 3000000 && income < 50000000){
            bonusP = 3;
        }else if (income >= 50000000){
            bonusP = 5;
        }

        float bonus = (float) (income * (bonusP*0.01));
        int totalSalary = (int) (salary + bonus);

        System.out.println("======================");
        System.out.println("매출액 : " + income);
        System.out.println("보너스율 : " + bonusP + "%");
