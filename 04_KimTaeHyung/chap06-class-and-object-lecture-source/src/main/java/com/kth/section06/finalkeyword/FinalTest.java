package com.kth.section06.finalkeyword;

import com.kth.section06.statickeyword.StaticTest;
...
public class FinalTest {
  ...
  * NON_STATIC_NUM이 같이 할당됨 */
  ...
  // 인스턴스가 생성될 때 값이 대입되지 않은 final 필드에 자동으로 0이 초기화 되는 문제가 발생 -> 원하는 값 대입 불가능
