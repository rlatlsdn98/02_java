...
public class Application {
  public static void main(String[] args) {
    ...
    *  */
    ...
    System.out.println("b2 : " + b2); // 참조변수이기때문에 b2 주소가 출력될...줄 알았지만 toString 자동호출
    ...
    System.out.println("동일한가?(참조 주소 비교) " + (b3 == b4)); // New object is compared using '=='

    //b3, b4 동등 비교(equals(), 객체가 가지고 있는 값/필드 값이 모두 같은지 비교)
    System.out.println("동등한가?(필드 값 비교) " + (b3.equals(b4)));
