...
public class Application2 {
  public static void main(String[] args) {
    ...
    /* String의 불변성
     * - String은 한 번 값을 저장하면 바꿀 수 없다(final field) => 내부적으로 byte 배열로 저장됨
    ...
    /* String 객체를 만드는 방법 2가지~
     * 1) String s1 = "abcd";
     *  -> Heap 메모리 영역의 Constant Pool에 생성됨
     *  -> 만약 String s3 = "abcd"를 새로 선언하면,
     *     Constant pool에 같은게 있는지 먼저 검색함.
     *     있다면, 그걸 참조해옴.
     *
    ...
    String str1 = "java"; //str1은 참조자료형 = 주소를 저장함
    String str2 = "java"; //str1, str2는 Constant Pool의 "java"를 참조중
    String str3 = new String("java"); // heap의 Constant Pool이 아닌 곳에 "java"객체를 생성
    String str4 = new String("java");

    System.out.println("(str1==str2) : " + (str1 == str2)); // 같은 공간을 참조하고 있다
    ...
    System.out.println(System.identityHashCode(str1));//오버라이딩 전 주소에 관한 hashcode 반환
    System.out.println(System.identityHashCode(str2));//str1이랑 str2는 같은 constant pool을 조회
