package org.ho.section06.finalkeyword;
...
public class FinalTest {
  ...
  // - 해결방법 1) 바로 값 대입 (명시적 초기화)
  // - 해결방법 2) 생성자를 이용한 값 초기화
  private final int NON_STATIC_NUM2;
//  NON_STATIC_NUM2 =2; // (에러)

  // - 해결방법 2)
  public FinalTest() {
    this.NON_STATIC_NUM2 = 100; //생성자가 JVM 기본값 대입 보다 우선순위가 높다

  }

  public void test() {
    final int A;  //지역변수 (Stack)
    A = 100;
  }
}
