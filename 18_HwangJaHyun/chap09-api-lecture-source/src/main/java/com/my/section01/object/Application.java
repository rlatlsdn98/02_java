package com.my.section01.object;

public class Application {
  public static void main(String[] args) {
    Book b1 = new Book(1, "홍길동전", "허균", 50000);
    Book b2 = new Book(2, "모브사이코100", "ONE", 5000);
    Book b3 = new Book(3, "원펀맨", "ONE", 5000);
    ...
    * 컴파일러가 자동으로 .toString()을 추가해준다.*/
    ...
    Book b4 = new Book(3, "원펀맨", "ONE", 5000);

    // b3, b4 동일 비교(==, 참조하고 있는 주소가 같은 지 비교)
