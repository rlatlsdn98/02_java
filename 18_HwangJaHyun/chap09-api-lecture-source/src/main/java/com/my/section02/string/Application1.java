package com.my.section02.string;
...
public class Application1 {
  public static void main(String[] args) {
    ...
    /* 3. concat() : 문자열에 인자로 전달된 문자열을 합치기해서 새로운 문자열을 반환한다.
     * 원본 문자열에는 영향을 주지 않는다.
     * */
    String str6 = "java";
    String str7 = "oracle";
    ...
    /* 4. trim() : 문자열의 앞 뒤에 공백을 제거한 문자열을 반환한다. */
    ...
    /* 6. substring() : 문자열의 일부분을 잘라내어 새로운 문자열을 반환한다.
     * 원본에 영향을 주지 않는다.
     * */
    ...
    /* 7. replace() : 문자열에서 대체할 문자열로 기존 문자열을 변경해서 반환한다.
     * 원본에 영향을 주지 않는다.
     * */
