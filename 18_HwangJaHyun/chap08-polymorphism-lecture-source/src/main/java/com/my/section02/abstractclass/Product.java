...
public abstract class Product {
  ...
  private static int staticField; // 클래스 변수, 할당될때 Product(클래스명).staticField
  ...
  public void nonStaticMethod(){
    System.out.println("Product클래스의 nonStaticMethod()");
  }
  ...
  *
  * 추상 메서드가 존재하는 클래스에는 반드시 abstract 키워드가 붙어야한다!
  * 
  * 추상메서드는 상속받은 자식클래스에서
